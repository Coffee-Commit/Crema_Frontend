...
export async function swapToScreen(publisher: Publisher, options: ScreenShareOptions = {}): Promise<ScreenShareContext> {
...
export async function swapToCamera(publisher: Publisher, ctx: ScreenShareContext) {
  try {
