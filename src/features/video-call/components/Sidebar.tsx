...
import { useActiveTab, useShouldShowChatBadge, useUIState, useVideoCallActions } from '../store'
...
export default function Sidebar() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'settings':
        return <div className="p-4 text-center text-[var(--color-label-subtle)]">설정 패널 준비 중</div>
      case 'network':
        return <NetworkPanel />
      default:
