...
export default function Footer() {
  return (
    <footer className="font-label5-regular bg-color-fill-white text-label-subtle px-container-padding-sm pt-spacing-xs lg:px-container-padding-lg container mx-auto flex w-full flex-col">
      <div className="gap-spacing-xs flex flex-col md:flex-row md:justify-between">
        ...
        <div className="gap-spacing-7xs flex flex-col leading-relaxed text-[var(--color-label-subtle)]">
          <p>(주)커피와커밋 | 대표 : 권재은</p>
          <p>
            서울특별시 마포구 상암로 210, B동 8층 (상암동, 디지털타워)
